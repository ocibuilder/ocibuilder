...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/ocibuilder/ocibuilder/pkg/apis/ocibuilder/v1alpha1.ImageBuildResponse": schema_pkg_apis_ocibuilder_v1alpha1_ImageBuildResponse(ref),
...
func schema_pkg_apis_ocibuilder_v1alpha1_ImageBuildResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ImageBuildResponse is the response from the image build command",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"Body": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("io.ReadCloser"),
						},
					},
				},
