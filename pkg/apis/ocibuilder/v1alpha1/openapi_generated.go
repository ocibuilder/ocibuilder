		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"buildContextPath": {
						SchemaProps: spec.SchemaProps{
							Description: "BuildContextPath is the path of the build context for Docker and Buildah defaults to LocalContext in current working directory",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"buildFile": {
						SchemaProps: spec.SchemaProps{
							Description: "BuildFile is the path to the buildfile that was used for the image build",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"contextDirectory": {
						SchemaProps: spec.SchemaProps{
							Description: "ContextDirectory is the path to the build context",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"daemon": {
						SchemaProps: spec.SchemaProps{
							Description: "Daemon is whether the daemon was used to build or not (Docker or Buildah)",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
				},
				Required: []string{"buildFile", "contextDirectory", "daemon"},
			},
		},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "Registry is the name of the registry Registry string `json:\"registry\" protobuf:\"bytes,1,name=registry\"` Image to push",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tag": {
						SchemaProps: spec.SchemaProps{
							Description: "User is the name of kubernetes namespace User string `json:\"user\" protobuf:\"bytes,3,name=user\"` Token required for the OCI complaint registry authentication Token string `json:\"token\" protobuf:\"bytes,4,name=token\"` Tag version of the image (e.g: v0.1.1)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
