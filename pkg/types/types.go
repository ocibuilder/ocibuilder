...
type OCIBuildOptions struct {
	...
	dockertypes.ImageBuildOptions `json:"imageBuildOptions,inline" protobuf:"bytes,1,name=imageBuildOptions"`
	...
	Ctx context.Context `json:"ctx" protobuf:"bytes3,name=ctx"`
...
type OCIBuildResponse struct {
	...
	dockertypes.ImageBuildResponse `json:"imageBuildResponse,inline" protobuf:"bytes,1,name=imageBuildResponse"`
...
type OCIPullOptions struct {
	...
	dockertypes.ImagePullOptions `json:"imagePullOptions,inline" protobuf:"bytes,1,name=imagePullOptions"`
	// Ref is the reference image name to pull
	Ref string `json:"ref,inline" protobuf:"bytes,2,name=ref"`
	// Ctx is the goroutine context
	Ctx context.Context `json:"ctx,inline" protobuf:"bytes3,name=ctx"`
}
...
type OCIPushOptions struct {
	...
	dockertypes.ImagePushOptions `json:"imagePushOptions,inline" protobuf:"bytes,1,name=imagePushOptions"`
...
type OCIRemoveOptions struct {
	...
	dockertypes.ImageRemoveOptions `json:"imageRemoveOptions,inline" protobuf:"bytes,1,name=imageRemoveOptions"`
	// Image is the name of the image to remove
	Image string `json:"image,inline" protobuf:"bytes,2,name=image"`
	// Ctx is the goroutine context
	Ctx context.Context `json:"ctx,inline" protobuf:"bytes,3,name=ctx"`
}
...
type OCIRemoveResponse struct {
	...
	Response []dockertypes.ImageDeleteResponseItem `json:"response,inline" protobuf:"bytes,1,name=response"`
	// Exec is part of the response for Buildah command executions
	Exec *command.Command `json:"exec,inline" protobuf:"bytes,2,name=exec"`
	// Stderr is the stderr output stream used to stream buildah response
	Stderr io.ReadCloser `json:"stderr,inline" protobuf:"bytes,3,name=stderr"`
...
type OCILoginOptions struct {
	...
	dockertypes.AuthConfig `json:"authConfig,inline" protobuf:"bytes,1,name=authConfig"`
	// Ctx is the goroutine context
	Ctx context.Context `json:"ctx,inline" protobuf:"bytes,2,name=ctx"`
}
